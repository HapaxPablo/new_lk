...
export default function AccreditationPage() {
    ...
    const breadcrumbItems = [
        ...
        { name: 'Аккредитация', url: `${SITE_URL}/accreditation` },
    ]
                ...
                <div className="max-w-4xl mx-auto px-4 py-12">
                    ...
                    <section className="mb-12 border-t pt-8">
                        ...
                        <ul className="list-disc list-inside space-y-4 text-gray-700">
                            <li><span className="font-medium">Код 12.01</span> — Оказание услуг с использованием собственных программ для ЭВМ и баз данных, включая предоставление удалённого доступа, для учёта и распространения рекламы</li>
