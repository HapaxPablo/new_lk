      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-14 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-white/85">
            Подберите рекламные площадки в торговых центрах {cityName}:
            аудиоролики, видеоролики, indoor-экраны и объявления в местах с
            высоким ежедневным трафиком.
          </p>
        ...
        <EntityCard className="p-6 shadow-2xl">
          <div className="mb-5">
            <div className="text-xl font-black text-slate-900">
              Быстрый подбор площадок
            </div>
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Оставьте параметры кампании — подберём торговые центры и
              рассчитаем размещение рекламы.
            </p>
          </div>

          <div className="space-y-3">
            <input
              className="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-[#ef5350]"
